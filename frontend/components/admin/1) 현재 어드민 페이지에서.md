Changelog
- v0.2.0 (2025-12-22, GitHub Copilot): 어드민 상태조회에 닉네임/골드·플래티넘·다이아 전부 노출, CSV 데이터만으로 로그인하도록 user_<nickname> 자동 생성 제거, 추천 부활 기능 백/프론트/데이터 일괄 삭제, 플래티넘 연속 진행 문구 삭제, 사용자 페이지 Contact 푸터 외부 링크 연결 및 라벨 수정.
