...
| **1** | 유틸리티 분리 | ⏳ 대기 | `utils/*.py` |
| **2** | 라우터 분리 | ⏳ 대기 | `routers/*.py` |
| **3** | 서비스 레이어 | ⏳ 대기 | `services/*.py` |
| **4** | 프론트엔드 리팩토링 | ⏳ 대기 | `components/vault/*` |
| **5** | DB 마이그레이션 | ⏳ 대기 | `DB_MIGRATION_V3.sql` 적용 |
...
| 4 | Backend 상수 참조 변경 | `main.py` | 🔴 P0 |
| 5 | Frontend 상수 참조 변경 | `index.jsx` | 🔴 P0 |
| 6 | 테스트 실행 및 검증 | - | 🔴 P0 |
