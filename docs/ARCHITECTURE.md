...
- 플래티넘: 손실 공포 핵심 — “20,000원이 곧 소멸” 메시지, 진행률(연속 3일/리뷰 키) 표시
...
- API (예시)
	...
	- POST /api/vault/attendance: (참고) 수동 출석(데모/QA) — 기본 운영 플로우는 업로드 기반
	- POST /api/vault/user-daily-import: 운영 업로드 기반 진행률/상태 갱신(권장)

## Changelog
- 2025-12-20 v2.0: 초기 초안
- 2025-12-20 v2.0.1: 플래티넘 20,000 기준 정합화, 출석은 업로드 기반을 기본으로 명시
- 도메인 서비스
