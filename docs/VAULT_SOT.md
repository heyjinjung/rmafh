...
#### 해금 조건
| 순서 | 조건 ID | 조건명 | 검증 필드 | 힌트 |
|------|---------|--------|-----------|------|
| 1 | `g1` | CC카지노 공식채널 입장 | `telegram_ok` | 각종 이벤트 및 보너스 드랍 진행 |
| 2 | `g2` | 담당실장 공식채널 입장 | `telegram_ok` | 본사혜택 외 추가 이벤트 진행 |
| 3 | `g3` | 간편 본인확인 | `gold_status === 'UNLOCKED'` | 담당실장에게 본인 확인 |
